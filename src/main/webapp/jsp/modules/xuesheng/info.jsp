						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="kaoshengbianhao" name="kaoshengbianhao" class="form-control" v-model="ruleForm.kaoshengbianhao" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>密码</label>
									...
									<input id="kaoshengxingming" name="kaoshengxingming" class="form-control" v-model="ruleForm.kaoshengxingming" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>性别</label>
