...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3">
								<div class="col-sm-12">
									...
									<input type="text" id="kaoshengbianhaoSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
									<label>
										考生姓名
									</label>
									<input type="text" id="kaoshengxingmingSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('kaoshengbianhao')">考生编号<i id="kaoshengbianhaoIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('mima')">密码<i id="mimaIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('kaoshengxingming')">考生姓名<i id="kaoshengxingmingIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#kaoshengbianhaoSearch').val() != null && $('#kaoshengbianhaoSearch').val() != ''){
				searchForm.kaoshengbianhao ="%" +  $('#kaoshengbianhaoSearch').val() + "%";
			}
			
			if($('#kaoshengxingmingSearch').val() != null && $('#kaoshengxingmingSearch').val() != ''){
				searchForm.kaoshengxingming ="%" +  $('#kaoshengxingmingSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("xuesheng/page","GET",{
				...
				sort: sortColumn,
				order: sortOrder,
				kaoshengbianhao : searchForm.kaoshengbianhao,	
				kaoshengxingming : searchForm.kaoshengxingming,	
			},(res)=>{
				if(res.code == 0){
					clear();
		...
		function setDataRow(item,number){
			...
			var kaoshengbianhaoCell  = document.createElement('td');

						 kaoshengbianhaoCell.innerHTML = item.kaoshengbianhao;


			row.appendChild(kaoshengbianhaoCell);
			...
			var kaoshengxingmingCell  = document.createElement('td');

						 kaoshengxingmingCell.innerHTML = item.kaoshengxingming;


			row.appendChild(kaoshengxingmingCell);
