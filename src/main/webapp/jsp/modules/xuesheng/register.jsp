	...
	<div class="container">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<label class="label">考生编号</label> 
							<input type="text" name="kaoshengbianhao" placeholder="考生编号" class="form-control-i">
							</div>
																								<div class="form-group">
							...
							<input type="text" name="mima" placeholder="密码" class="form-control-i">
																								...
																								<div class="form-group">
							<label class="label">考生姓名</label> 
							<input type="text" name="kaoshengxingming" placeholder="考生姓名" class="form-control-i">
							</div>
																																														<div class="form-group">
