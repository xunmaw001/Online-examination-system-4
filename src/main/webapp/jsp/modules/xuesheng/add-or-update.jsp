...
<body>
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>考生编号</label>
										<input id="kaoshengbianhao" name="kaoshengbianhao" class="form-control" placeholder="考生编号">
									</div>
									<div class="form-group col-md-6">
										<label>密码</label>
									...
									<div class="form-group col-md-6">
										<label>考生姓名</label>
										<input id="kaoshengxingming" name="kaoshengxingming" class="form-control" placeholder="考生姓名">
									</div>
									<div class="form-group col-md-6">
										<label>性别</label>
	...
	<script>
		...
		function dataBind(){
			...
			$("#kaoshengbianhao").val(ruleForm.kaoshengbianhao);	
			$("#mima").val(ruleForm.mima);	
			$("#kaoshengxingming").val(ruleForm.kaoshengxingming);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.kaoshengbianhao != null && res.data.kaoshengbianhao != ''){

					$("#kaoshengbianhao").val(res.data.kaoshengbianhao);
					}
					if(res.data != null && res.data != '' && res.data.mima != null && res.data.mima != ''){

					$("#mima").val(res.data.mima);
					}
					if(res.data != null && res.data != '' && res.data.kaoshengxingming != null && res.data.kaoshengxingming != ''){

					$("#kaoshengxingming").val(res.data.kaoshengxingming);
					}
