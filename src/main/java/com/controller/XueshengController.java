...
public class XueshengController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		XueshengEntity user = xueshengService.selectOne(new EntityWrapper<XueshengEntity>().eq("kaoshengbianhao", username));
    ...
    public R register(@RequestBody XueshengEntity xuesheng){
    	...
    	XueshengEntity user = xueshengService.selectOne(new EntityWrapper<XueshengEntity>().eq("kaoshengbianhao", xuesheng.getKaoshengbianhao()));
		if(user!=null) {
